		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "hello_world",
									"targetURL": "#democomdemohello-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"democomdemohello-display": {
								"semanticObject": "democomdemohello",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.com.demohello",
									"url": sap.ui.require.toUrl("demo/com/demohello")
								}
							}
						}
					}
